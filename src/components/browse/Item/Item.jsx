...
class MyComponent extends Component {
    ...
    render() {
        ...
        let {imageUrl,_id,title} = this.props.tokenInfo
        return (
            <div>
                <div className="card" style={{background: 'var(--bs-white)',width:'32.33%', float: 'left',display:'inline',marginLeft:"1%",marginBottom:"1%"}}>
                    ...
                    <div className="card-body">
                        <p className="text-white" style={{color: 'var(--bs-secondary)',bsBodyColor: 'var(--bs-secondary)', borderColor: 'var(--bs-secondary)',bsBodyBg: 'var(--bs-secondary)', opacity: 1, filter: 'brightness(0%) contrast(171%) grayscale(0%)'}}>TokenID: {_id}</p>
